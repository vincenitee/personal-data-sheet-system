...
<div class="mx-auto hidden w-[65%] py-2" data-step>
    ...
    <div class="grid grid-cols-4 gap-x-4 gap-y-3">
        ...
        <div class="col-span-2 space-y-1">
            ...
            <input type="text" name="elem-school" id="elem-school" class="inputbox group" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">Degree</label>
            <input type="text" name="elem-degree" id="elem-degree" class="inputbox" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">Highest Level Earned</label>
            <input type="text" name="elem-highest-unit" id="elem-highest-unit" class="inputbox" autocomplete="off" />
        </div>
        ...
        <div class="space-y-1">
            ...
            <div class="relative">
                ...
                <input type="text" name="elem-start-date" id="elem-start-date" class="date-inputbox" autocomplete="off" placeholder="Select date" required />
            </div>
        </div>
        ...
        <div class="space-y-1">
            ...
            <div class="relative">
                ...
                <input type="text" name="elem-end-date" id="elem-end-date" class="date-inputbox" autocomplete="off" placeholder="Select date" required />
            </div>
        </div>
        ...
        <div class="space-y-1">
            ...
            <input type="text" name="elem-awards" id="elem-awards" class="inputbox" autocomplete="off" />
        </div>
        ...
        <div class="col-span-2 space-y-1">
            <label class="block text-sm font-medium text-gray-700">Name of School</label>
            <input type="text" name="secondary-school" id="secondary-school" class="inputbox group" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">Degree</label>
            <input type="text" name="secondary-degree" id="secondary-degree" class="inputbox" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">Highest Level Earned</label>
            <input type="text" name="secondary-highest-unit" id="secondary-highest-unit" class="inputbox" autocomplete="off" />
        </div>
        ...
        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700"> Awards Received</label>
            <input type="text" name="secondary-awards" id="secondary-awards" class="inputbox" autocomplete="off" />
        </div>
        ...
        <div class="col-span-2 space-y-1">
            <label class="block text-sm font-medium text-gray-700">Name of School</label>
            <input type="text" name="vocational-school" id="vocational-school" class="inputbox group" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">Degree</label>
            <input type="text" name="vocational-degree" id="vocational-degree" class="inputbox" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">Highest Level Earned</label>
            <input type="text" name="vocational-highest-unit" id="vocational-highest-unit" class="inputbox" autocomplete="off" />
        </div>
        ...
        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700"> Awards Received</label>
            <input type="text" name="vocational-awards" id="vocational-awards" class="inputbox" autocomplete="off" />
        </div>
        ...
        <div class="col-span-2 space-y-1">
            <label class="block text-sm font-medium text-gray-700">Name of School</label>
            <input type="text" name="college-school" id="college-school" class="inputbox group" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">Degree</label>
            <input type="text" name="college-degree" id="college-degree" class="inputbox" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">Highest Level Earned</label>
            <input type="text" name="college-highest-unit" id="college-highest-unit" class="inputbox" autocomplete="off" />
        </div>
        ...
        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700"> Awards Received</label>
            <input type="text" name="college-awards" id="college-awards" class="inputbox" autocomplete="off" />
        </div>
        ...
        <div class="col-span-2 space-y-1">
            <label class="block text-sm font-medium text-gray-700">Name of School</label>
            <input type="text" name="graduate-school" id="graduate-school" class="inputbox group" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">Degree</label>
            <input type="text" name="graduate-degree" id="graduate-degree" class="inputbox" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">Highest Level Earned</label>
            <input type="text" name="graduate-highest-unit" id="graduate-highest-unit" class="inputbox" autocomplete="off" />
        </div>
        ...
        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700"> Awards Received</label>
            <input type="text" name="graduate-awards" id="graduate-awards" class="inputbox" autocomplete="off" />
        </div>
    </div>
</div>