<!--Personal details -->
<div class="mx-auto hidden w-3/4 py-2" data-step id="personal-details">
    <!-- Title -->
    ...
    <div class="grid grid-cols-4 gap-x-4 gap-y-3">
        ...
        <div class="space-y-1">
            ...
            <div class="group relative">
                ...
                <label class="pointer-events-none absolute inset-x-2 inset-y-2.5 text-gray-500 transition-all duration-100 ease-in group-focus-within:inset-y-1 group-focus-within:text-xs">Select Gender/Sex</label>
            </div>
        </div>
        ...
        <div class="space-y-1">
            ...
            <div class="group relative">
                ...
                <label class="pointer-events-none absolute inset-x-2 inset-y-2.5 text-gray-500 transition-all duration-100 ease-in group-focus-within:inset-y-1 group-focus-within:text-xs">Select Civil Status</label>
            </div>
        </div>
        ...
        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">GSIS ID Number</label>
            <input type="number" name="gsis-id" id="gsis-id" class="inputbox" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">PAG-IBIG ID Number</label>
        ...
        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">SSS ID Number</label>
            <input type="number" name="sss-id" id="sss-id" class="inputbox" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">TIN ID Number</label>
            <input type="number" name="tin-id" id="tin-id" class="inputbox" autocomplete="off" />
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">Agency Employee Number</label>
        ...
        <div class="space-y-1">
            ...
            <div class="group relative">
                ...
                <label class="pointer-events-none absolute inset-x-2 inset-y-2.5 text-gray-500 transition-all duration-100 ease-in group-focus-within:inset-y-1 group-focus-within:text-xs">Select Nationality</label>
            </div>
        </div>

        <div class="space-y-1">
            <label class="block text-sm font-medium text-gray-700">Citizenship Category</label>
            <div class="group relative">
                ...
                <label class="pointer-events-none absolute inset-x-2 inset-y-2.5 text-gray-500 transition-all duration-100 ease-in group-focus-within:inset-y-1 group-focus-within:text-xs">Select Citizenship Category</label>
            </div>
        </div>

        <div class="col-span-2 space-y-1">
            <label class="block text-sm font-medium text-gray-700">If holder of dual citizenship, indicate country</label>
            <div class="group relative">
                <select name="citizenship-country" id="citizenship-country" class="dropdown" required>
                    <option value=""></option>
                    <option value="N/A">N/A</option>
                </select>
                <label class="pointer-events-none absolute inset-x-2 inset-y-2.5 text-gray-500 transition-all duration-100 ease-in group-focus-within:inset-y-1 group-focus-within:text-xs">Select Country</label>
            </div>
        </div>
        ...
        <div class="group relative">
            ...
            <label class="pointer-events-none absolute inset-x-2 inset-y-2.5 text-gray-500 transition-all duration-100 ease-in group-focus-within:inset-y-1 group-focus-within:text-xs">House no./Block no./Lot no.</label>
        </div>

        <div class="group relative">
            <input type="text" name="res-street" id="res-street" class="address-inputbox" autocomplete="off" required />
            <label class="pointer-events-none absolute inset-x-2 inset-y-2.5 text-gray-500 transition-all duration-100 ease-in group-focus-within:inset-y-1 group-focus-within:text-xs">Street</label>
        </div>
        ...
        <div class="group relative col-span-2">
            ...
            <label class="pointer-events-none absolute inset-x-2 inset-y-2.5 text-gray-500 transition-all duration-100 ease-in group-focus-within:inset-y-1 group-focus-within:text-xs">Village</label>
        </div>
        ...
        <div class="group relative">
            ...
            <label class="pointer-events-none absolute inset-x-2 inset-y-2.5 text-gray-500 transition-all duration-100 ease-in group-focus-within:inset-y-1 group-focus-within:text-xs">Province</label>
        </div>
        ...
        <div class="group relative">
            ...
            <label class="pointer-events-none absolute inset-x-2 inset-y-2.5 text-gray-500 transition-all duration-100 ease-in group-focus-within:inset-y-1 group-focus-within:text-xs">Municipality</label>
        </div>
        ...
        <div class="group container relative">
            ...
            <label class="pointer-events-none absolute inset-x-2 inset-y-2.5 text-gray-500 transition-all duration-100 ease-in group-focus-within:inset-y-1 group-focus-within:text-xs">Baranggay</label>
        </div>

        <div class="group container relative">
            <input name="res-zip" id="res-zip" class="address-inputbox" required />
            <label class="pointer-events-none absolute inset-x-2 inset-y-2.5 text-gray-500 transition-all duration-100 ease-in group-focus-within:inset-y-1 group-focus-within:text-xs">Zip Code</label>
        </div>
